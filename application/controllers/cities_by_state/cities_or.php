...
$url ="https://api.scraperwiki.com/api/1.0/datastore/sqlite?format=jsondict&name=city_representatives_-_oregon&query=$query";		
...
foreach ($officials as $official) {
	...
	$electeds[] = $this->elected_official_model($type = $elected_type, 
											  ...
											  $address_2 = null, 
											  $address_city = $official['address_city'], 
											  $address_state = $official['address_state'], 
											  $address_zip = $official['address_zip'], 
